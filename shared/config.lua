...
QBCore = exports["qb-core"]:GetCoreObject() -- / planning to add ESX too
WashInventory = 'ox_inventory'  -- / 'ox_inventory', 'qb-inventory' -- / for some reason can't set it to Wash.Inventory lol

Wash = {}
Wash.Debug = true

Wash.Type = 'target' -- / 'zone', 'target'
Wash.Notify = 'ox' -- / 'ox', 'qb'
